                                ...
                                <tbody class="text-gray-600 text-sm font-light">
                                    @foreach($assUsers as $assUser)
                                        <tr class="border-b border-gray-200 bg-gray-100 hover:bg-gray-200 hover:border-gray-300">
                                            ...
                                            <td class="py-3 px-6 text-left whitespace-nowrap">{{ $assUser->delegate_name }}</td>
                                            <td class="py-3 px-6 text-left sm:w-auto overflow-hidden text-ellipsis whitespace-nowrap truncate">{{ $assUser->delegate_email }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
