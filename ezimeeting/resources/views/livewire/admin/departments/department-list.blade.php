    ...
    <div class="container mx-auto px-4">
        ...
        <div class="container mx-auto py-8">
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                            ...
                            <tr class="border-b border-gray-200 bg-gray-100 hover:bg-gray-200 hover:border-gray-300">
                                ...
                                <td class="py-3 px-6 text-left items-center justify-between space-x-2">
                                    <div class="flex items-center space-x-2"> 
                                        <a href="{{ route('departmentUpdate', ['corporation'=>$corporation, 'department'=>$department->id]) }}" class="text-sm text-teal-500 font-semibold rounded hover:text-teal-800">
                                        ...
                                        <button wire:click="delete({{ $department }})" class="text-sm text-red-500 font-semibold rounded hover:text-teal-800 mr-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" class="w-8 h-8">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('departmentCreate', ['corporation'=>$corporation]) }}" class="inline-flex items-center m-2 px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded hover:bg-blue-700">
                    Add New Record
                </a>
            </div>
        </div>
